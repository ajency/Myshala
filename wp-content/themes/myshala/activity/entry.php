		...
		<?php if ( is_user_logged_in() ) : ?>
			...
			<div class="activity-meta">
				...
				<?php if ( bp_activity_can_comment() ) : ?>
					...
					<a href="<?php bp_get_activity_comment_link(); ?>" class=" acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>" style="margin-top:-10px;"><?php printf( __( 'Comment <span>%s</span>', 'buddypress' ), bp_activity_get_comment_count() ); ?></a>
				...
				<?php if ( bp_activity_user_can_delete() ): ?> 
						<?php $url = bp_get_root_domain() . '/' . bp_get_activity_root_slug() . '/delete/' . bp_get_activity_id();
						?>
						<a href="<?php echo wp_nonce_url( $url, 'bp_activity_delete_link' ) ?>"  class="crossbutton" ></a>
				<?php endif; ?>		
