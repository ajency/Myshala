...
<?php if ( bbp_current_user_can_access_create_reply_form() ) : ?>
	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form reply-form">
		<h5 class="reply-title">
			<?php printf( __( 'Reply To: <span>%s</span>', 'bbpress' ), bbp_get_topic_title() ); ?>
		</h5>
		<div class="reply-avatar">
			<?php  echo bp_core_fetch_avatar( array('item_id' => bp_loggedin_user_id()) ) ?>
		</div>
		<form id="new-post" name="new-post" method="post" action="" class="form-vertical contact-form">
				...
				<div>
					...
					<?php if ( !function_exists( 'wp_editor' ) ) : ?>
						<div class="line">
							...
							<!-- Textarea -->
							<label class="control-label" for="bbp_reply_content"><?php //_e( 'Reply:', 'bbpress' ); ?></label>
						  
							<textarea id="bbp_reply_content" tabindex="<?php bbp_tab_index(); ?>" name="bbp_reply_content" class="input-xxlarge"><?php bbp_form_reply_content(); ?></textarea>
								  
						</div>

					<?php else : ?>

						<?php bbp_the_content( array( 'context' => 'reply','before' => '<div class="control-group"><div class="controls"><div class="textarea">', 'after' => '</div></div></div>', 'textarea_rows' => '3', 'editor_class'  => 'input-xxlarge' ) ); ?>
					...
					<div class="line">
						...
						<!-- Text Tags -->
						<label class="control-label" for="bbp_topic_tags"><?php _e( 'Tags:', 'bbpress' ); ?></label>
					  
						<input type="text" value="<?php bbp_form_topic_tags(); ?>" tabindex="<?php bbp_tab_index(); ?>" class="input-xxlarge" name="bbp_topic_tags" id="bbp_topic_tags" <?php disabled( bbp_is_topic_spam() ); ?> />
					...
					<div class="line">
					  ...
					  <!-- Button -->
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_reply_submit" name="bbp_reply_submit" class="button submit btn btn-success"><?php _e( 'Reply', 'bbpress' ); ?></button>
