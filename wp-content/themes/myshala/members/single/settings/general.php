...
get_header( 'buddypress' ); ?>
	...
	<div id="content" class="block-6 no-mar content-with-sidebar">
		<div class="padder block-6 bg-color-main">
			...
			<div id="item-body" role="main" class="four-fifth last">
				...
				<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
					...
					<input type="password" name="pass1" id="pass1" size="16" value="" class="settings-input small" /> &nbsp;<span class="sg-text"><?php _e( 'New Password', 'buddypress' ); ?></span>
					<input type="password" name="pass2" id="pass2" size="16" value="" class="settings-input small" /> &nbsp;<span class="sg-text"><?php _e( 'Repeat New Password', 'buddypress' ); ?></span>
