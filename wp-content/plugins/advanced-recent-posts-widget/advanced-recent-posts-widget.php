...
class Advanced_Recent_Posts_Widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		?>
			...
			<li class="recent-post-item" style="list-style-type:none;">
...
<h5><a  href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent link to <?php the_title_attribute(); ?>" class="post-title"><?php the_title(); ?></a></h5></div>
...
<div class="post-text" style="margin-top: -8px;">
			...
			<?php echo get_the_excerpt() . $linkmore; ?>
